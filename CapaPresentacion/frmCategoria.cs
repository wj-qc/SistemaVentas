        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            if (obj.IdCategoria == 0)
            {
                ...
                if (idgenerado != 0)
                {
                    ...
                    MessageBox.Show("Categoría registrada exitosamente.", "Confirmación", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
            ...
            else
            {
                ...
                if (resultado)
                {
                    ...
                    // Mensaje de confirmación
                    MessageBox.Show("Categoría editada exitosamente.", "Confirmación", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
                    MessageBox.Show(mensaje);
